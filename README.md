...
AI Engine: Google Gemini 2.5 Flash-Lite via Supabase Edge Functions.

State Management: TanStack Query (React Query) v5.

Edge Functions & AI
The project utilizes high-performance Deno-based Edge Functions to handle AI processing.
...
Optimization: JSON-mode for structured pedagogical data.
